...
Uryadi = ('ऊरी', 'उररी', 'तन्थी', 'ताली', 'आत्ताली', 'वेताली', 'धूली', 'धूस', 'शकला', 'संशकला', 'ध्वंसकला', 'भ्रंसकला', 'गुलुगुधा', 'सजूस्', 'फल', 'फली', 'विक्ली', 'आक्ली', 'आलोष्ठी', 'केवाली', 'केवासी',
          'सेवासी', 'पर्याली', 'शेवाली', 'वर्षाली', 'अत्यूमशा', 'मश्मशा', 'मस्मसा', 'मसमसा', 'औषट्', 'श्रौषट्', 'वौषट्', 'वषट्', 'स्वाहा', 'स्वधा', 'वन्धा', 'प्रादुस्', 'श्रत्', 'आविस्')
...
def getPratyahara(pratyahara: str, withSavarnas=True, paraNakara=False):
    ...
    for sut in l_maheshvarani:
        ...
        for i in range(len(s_vig)):
            if s_vig[i] == pthara[0] and (len(s_vig[i]) == 1 or (i != len(s_vig) - 1)):
                started = True
